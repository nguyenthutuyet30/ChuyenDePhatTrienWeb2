    ...
    <div class="container">
        ...
        <div class="page_content">
            <div class="position-relative">
                <div class="position-absolute" id="img-video" onclick="show()">
                    <img src="images/maxresdefault.jpg" alt="" width="100%" height="600">
                    <div class="icon-video">
                        <i class="fa fa-youtube-play"></i>
                    </div>
                </div>
                <iframe width="100%" height="600" frameborder="0"
                    src="Videos/Let's make your Joomla shine!.mp4"></iframe>
            </div>
            <!-- Meta content -->
            <div class="meta_content">
                <h2>VIDEO TYPE</h2>
        ...
        <div class="pagination">
            ...
            <ul class="number_page">
                ...
                <li><a href="" class="pagenav">Next</a></li>
                <li><a href="" class="pagenav">End</a></li>
            </ul>
        </div>
    </div>
</div>
