...
<div class="type-4">
    <div class="container">
        <!--xEM lại phần code tiêu đề và code lại -->
        <h3 class="text-center box-title"><span>POPUPLAR PROPERTIES</span></h3>
        <!-- row 1 -->
        <div class="row">
            ...
            <div class="col-lg-4 col-12">
                <div class="item_img">
                    <img src="images/popular-properties-1" alt="">
                </div>
                <div class="item_content">
                    <div class="pt-4 pb-4">
                        <h4>
            ...
            <div class="col-lg-4 col-12">
                <div class="item_img">
                    <img src="images/popular-properties-3" alt="">
                </div>
                <div class="item_content">
                    <div class="pt-4 pb-4">
                        <h4>
        ...
        <div class="row mt-4 mb-4">
            <div class="col-lg-4 col-12">
                <div class="item_img">
                    <img src="images/popular-properties-4.png" alt="">
                </div>
                <div class="item_content">
                    <div class="pt-4 pb-4">
                        <h4>
            ...
            <div class="col-lg-4 col-12">
                <div class="item_img">
                    <img src="images/popular-properties-5" alt="">
                </div>
                <div class="item_content">
                    <div class="pt-4 pb-4">
                        <h4>
            ...
            <div class="col-lg-4 col-12">
                <div class="item_img">
                    <img src="images/popular-properties-6" alt="">
                </div>
                <div class="item_content">
                    <div class="pt-4 pb-4">
                        <h4>
