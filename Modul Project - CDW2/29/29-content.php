...
<div class="type-29">
    <div class="container">
        ...
        <div class="property_meta">
            <ul>
                <li><i class="fa fa-arrows" aria-hidden="true"></i>&nbsp;Get direction</li>
                <li><i class="fa fa-print" aria-hidden="true"></i><span>&nbsp;Print this
                        page</span>&emsp;</li>
                <li><i class="fa fa-file-pdf-o" aria-hidden="true"></i><span>&nbsp;PDF</span>&emsp;
                </li>
                <li><i class="fa fa-th-list" aria-hidden="true"></i><span>&nbsp;Add to compare
                        list</span></li>
            </ul>
        </div>
