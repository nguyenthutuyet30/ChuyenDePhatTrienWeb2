    ...
    <div class="container">
        ...
        <div class="detail_description">
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="images/popular-properties-1" alt="First slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="images/popular-properties-2" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="images/popular-properties-3" alt="Third slide">
                            </div>
                        </div>
                    ...
                    <ul class="list-img d-flex flex-row">
                        <li><img src="images/popular-properties-1" alt="" class="w-100"></li>
                        <li><img src="images/popular-properties-2" alt="" class="w-100"></li>
                        <li><img src="images/popular-properties-3" alt="" class="w-100"></li>
                    </ul>
                </div>
                <div class="col-lg-6 col-12">
                    <h3>For Sale</h3>
                    <ul class="table_info">
                        ...
                        <li><b>Category:</b>&emsp;Villa</li>
                        <li><b>Tags:</b>&emsp;#Ciputra #A1</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="report">
            <div class="property-title">
                ...
                <span class="pull-right">€ 500.00</span>
        ...
        <div class="social">
            <span><i class="fa fa-share-alt" aria-hidden="true"></i>&nbsp;Share</span>&emsp;
            <span><i class="fa fa-facebook" aria-hidden="true"></i>&nbsp;Facebook</span>&emsp;
