            ...
            <div class="row">
                <div class="col-lg-3 col-md-12 col-xs-12">
                    <div class="box-style">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc varius nisl id lectus ultricies
                            ut
                ...
                <div class="col-lg-6 col-md-12 col-xs-12">
                    <div>
                        ...
                        <div class="date">
                            <i class="fa fa-calendar" aria-hidden="true"></i>
                            <span>Create: 01 April 2011</span>
                        </div>
                        <p>With the powerful Sun Framework, module styles in JSN templates, starting from JSN Reta 2,
                            will
                            no longer be limited in a fixed number of boxed designs. For module styling, it's totally up
                            to
                            users to decide the styling properties of the modules. Take a look around to see how module
                            styles are applied.</p>
                        <p>Module styles are configured inside Style tab (Style --> Module). You no longer need to
                            remember
                            the name of the module style or go through the document to find out a style name, as it can
                            be
